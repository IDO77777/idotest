const images = [
   ...
   {src: 'img/ロット形式ポスト.svg', width: 255, height: 175.65, type: 'img'},
   {src: 'img/物と情報の停滞.svg', width: 251.08, height: 234.84, type: 'img'},
   {src: 'img/ストア（店）.svg', width: 259.2, height: 181.74, type: 'img'},
   {src: 'img/紙・指示書.svg', width: 245.67, height: 174.88, type: 'img'},
   {src: 'img/Eメール.svg', width: 267.02, height: 218.31, type: 'img'},
   {src: 'img/FAX.svg', width: 204.36, height: 375.54, type: 'img'},
   {src: 'img/電話.svg', width: 254.62, height: 334.65, type: 'img'},
   {src: 'img/システム・アプリケーション.svg', width: 256.19, height: 365.41, type: 'img'},
]
