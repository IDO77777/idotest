const icon24 =
    '<svg width="16px" height="16px" xmlns="http://www.w3.org/2000/svg"><image href="https://ido77777.github.io/idotest/img/icon1.png" height="16px" width="16px"/></svg>'
...
function run() {
  miro.initialize({
    extensionPoints: {
      ...
      toolbar: {
        title: 'Dropper',
        librarySvgIcon: <svg width="16px" height="16px" xmlns="http://www.w3.org/2000/svg"><image href="https://ido77777.github.io/idotest/img/icon1.png" height="16px" width="16px"/></svg>,
        toolbarSvgIcon: <svg width="16px" height="16px" xmlns="http://www.w3.org/2000/svg"><image href="https://ido77777.github.io/idotest/img/icon1.png" height="16px" width="16px"/></svg>,
        onClick: () => {
